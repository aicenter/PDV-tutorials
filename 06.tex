...
{\setbeamertemplate{frame footer}{\see{{\tt mergesort\_parallel.h}, {\tt sorting.cpp} \sep {\tt make sorting}}}
\begin{frame}[fragile]
\frametitle{Paralelní merge sort}
...
{\setbeamertemplate{frame footer}{\see{{\tt countingsort.h}, {\tt sorting.cpp} \sep {\tt make sorting}}}
\begin{frame}
...
{\setbeamertemplate{frame footer}{\see{{\tt prefixsum.h}, {\tt prefixsum.cpp} \sep {\tt make prefixsum}}}
\begin{frame}
\frametitle{Prefixní suma}
...
% \end{frame}
 ...
 %  \end{enumerate}
   ...
   \>{\bf 6.4. 23:59 CET} pro čtvrteční cvičení.
 \end{tabbing}
