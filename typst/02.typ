...
// {\setbeamertemplate{frame footer}{\see{{\tt PDVCrypt.hpp},\ \ \ {\tt 5decrypt.cpp}}}
// \begin{frame}[fragile]
...
// {\setbeamertemplate{frame footer}{\see{{\tt 5decrypt.cpp}, \ \ \ {\tt PDVCrypt.hpp} }}
// \begin{frame}[fragile]
//   \frametitle{Šifra \texttt{PDVCrypt}}
...
#new-section[Zadání domácího úkolu]
