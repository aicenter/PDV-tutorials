...
#slide[
  ...
  #toolbox.side-by-side[
    #align(center, image("01/figs/single_thread.svg", width: 50%))
  ][
...
#slide[
  ...
  #align(center)[
    #image("01/figs/modern_cpu.svg", width: 80%)
  ]
]
...
#slide[
  ...
  #align(center)[
    #only("1")[
      #image("01/figs/false_sharing_1.svg", width: 80%)
    ]
    #only("2")[
      #image("01/figs/false_sharing_2.svg", width: 80%)
    ]
    #only("3")[
      #image("01/figs/false_sharing_3.svg", width: 80%)
    ]
    #only("4")[
      #image("01/figs/false_sharing_4.svg", width: 80%)
    ]
    #only("5")[
      #image("01/figs/false_sharing_5.svg", width: 80%)
    ]
  ]
