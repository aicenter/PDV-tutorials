...
%
%\begin{figure}
%  \only<2>{\includegraphics[scale=0.4]{figs/theory.pdf}}%
%  \only<3->{\includegraphics[scale=.4]{figs/practice.pdf}}%
%\end{figure}
%
%\pause
%
...
\begin{frame}[t]
	...
	\begin{figure}
		\centering\includegraphics[width=0.8\linewidth]{figs/sat1.pdf}
	\end{figure}
...
\begin{frame}[t]
	...
	Chceme splnit booleovskou funkci $\phi$ nad booleovskými proměnnými $x$, $y$, $z$, ...
	\begin{figure}
		\centering\includegraphics[width=0.8\linewidth]{figs/sat2.pdf}
	\end{figure}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{figure}
		\centering\includegraphics[width=0.7\linewidth]{figs/quicksort.png}
	\end{figure}
