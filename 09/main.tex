...
\frametitle{DSand framework}
  \begin{center}
    \only<1>{\includegraphics[width=0.9\linewidth]{figs/dsand1.pdf}}%
    \only<2>{\includegraphics[width=0.9\linewidth]{figs/dsand2.pdf}}%
    \only<3>{\includegraphics[width=0.9\linewidth]{figs/dsand3.pdf}}%
  \end{center}
  \vspace{-0.5em}
...
\begin{frame}
\begin{center}
\only<1>{\includegraphics[width=.8\linewidth]{figs/bfs01.pdf}}%
\only<2>{\includegraphics[width=.8\linewidth]{figs/bfs02.pdf}}%
\only<3>{\includegraphics[width=.8\linewidth]{figs/bfs03.pdf}}%
\only<4>{\includegraphics[width=.8\linewidth]{figs/bfs04.pdf}}%
\only<5>{\includegraphics[width=.8\linewidth]{figs/bfs05.pdf}}%
\end{center}
\end{frame}
...
\begin{center}
\only<1>{\includegraphics[width=.8\linewidth]{figs/dbfs01.pdf}}%
\only<2>{\includegraphics[width=.8\linewidth]{figs/dbfs02.pdf}}%
\only<3>{\includegraphics[width=.8\linewidth]{figs/dbfs03.pdf}}%
\only<4>{\includegraphics[width=.8\linewidth]{figs/dbfs04.pdf}}%
\end{center}
\end{frame}
